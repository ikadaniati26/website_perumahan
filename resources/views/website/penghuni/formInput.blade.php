                        ...
                        <fieldset class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_penghuni" id="gridRadios1" value="Kontrak" {{ old('status_penghuni') == 'Kontrak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="gridRadios1">
                                        Kontrak
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_penghuni" id="gridRadios2" value="Tetap" {{ old('status_penghuni') == 'Tetap' ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" id="status_menikah" name="status_menikah">
                                    ...
                                    <option value="Sudah" {{ old('status_menikah') == 'Sudah' ? 'selected' : '' }}>Sudah</option>
